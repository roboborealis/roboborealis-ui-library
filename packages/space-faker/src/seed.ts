...
/** Public alias for the {@link Rng} interface. */
export type SeededRng = Rng;

/**
 * Convenience factory matching the `createSeededRng` name re-exported from
 * the package index. Accepts a string or number seed.
 */
