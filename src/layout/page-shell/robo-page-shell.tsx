  ...
  return (
    ...
    >
      ...
      {sidebar && (
        ...
        // main content column, including any real WebGL canvas it renders (e.g.
        // RoboMapbox). That once trapped a sidebar descendant's own fixed-position
        // content behind the map canvas despite its own higher z-index, since a
        // child's z-index only wins within its nearest stacking-context ancestor,
        // not against sibling contexts outside it. An explicit z-index here
        // (matching the ambient map-overlay tier used elsewhere, e.g.
        // RoboMapOverlay's BASE_Z) fixes that at the source, and remains needed
        // for any future sidebar-adjacent floating UI (e.g. tooltips).
